...
static inline void DOWNLINK_SEND_ARDRONE_NAVDATA(struct DownlinkTransport *tp, uint16_t *_taille, uint16_t *_nu_trame, uint16_t *_ax, uint16_t *_ay, uint16_t *_az, int16_t *_vx, int16_t *_vy, int16_t *_vz, uint16_t *_temperature_acc, uint16_t *_temperature_gyro, uint16_t *_ultrasound, uint16_t *_us_debut_echo, uint16_t *_us_fin_echo, uint16_t *_us_association_echo, uint16_t *_us_distance_echo, uint16_t *_us_curve_time, uint16_t *_us_curve_value, uint16_t *_us_curve_ref, uint16_t *_nb_echo, uint32_t *_sum_echo, int16_t *_gradient, uint16_t *_flag_echo_ini, int32_t *_pressure, int16_t *_temperature_pressure, int16_t *_mx, int16_t *_my, int16_t *_mz, uint16_t *_chksum){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+4+2+2+4+2+2+2+2+2))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+4+2+2+4+2+2+2+2+2)); 
	  tp->StartMessage(tp->impl, "ARDRONE_NAVDATA", DL_ARDRONE_NAVDATA, 0+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+4+2+2+4+2+2+2+2+2); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _taille); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _nu_trame); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _ax); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _ay); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _az); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _vx); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _vy); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _vz); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _temperature_acc); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _temperature_gyro); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _ultrasound); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _us_debut_echo); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _us_fin_echo); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _us_association_echo); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _us_distance_echo); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _us_curve_time); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _us_curve_value); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _us_curve_ref); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _nb_echo); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _sum_echo); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _gradient); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _flag_echo_ini); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _pressure); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _temperature_pressure); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _mx); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _my); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _mz); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _chksum); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
static inline void DOWNLINK_SEND_DOWNLINK_STATUS(struct DownlinkTransport *tp, int8_t *_link_id, uint32_t *_run_time, uint32_t *_rx_bytes, uint32_t *_rx_msgs, uint32_t *_rx_err, float *_rx_bytes_rate, float *_rx_msgs_rate, float *_ping_time){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+4+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+4+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "DOWNLINK_STATUS", DL_DOWNLINK_STATUS, 0+1+4+4+4+4+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT8, 1, (void *) _link_id); 
...
static inline void DOWNLINK_SEND_MKK(struct DownlinkTransport *tp, int8_t *_nr, uint8_t *_rpm, int8_t *_current, int8_t *_temp){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+1+1))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+1+1)); 
	  tp->StartMessage(tp->impl, "MKK", DL_MKK, 0+1+1+1+1); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT8, 1, (void *) _nr); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT8, 1, (void *) _rpm); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT8, 1, (void *) _current); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT8, 1, (void *) _temp); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
static inline void DOWNLINK_SEND_DC_INFO(struct DownlinkTransport *tp, int16_t *_mode, float *_utm_east, float *_utm_north, float *_course, uint16_t *_buffer, float *_dist, float *_next_dist, float *_start_x, float *_start_y, float *_start_angle, float *_angle, float *_last_block, int16_t *_count, uint8_t *_shutter){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+4+4+4+2+4+4+4+4+4+4+4+2+1))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+4+4+4+2+4+4+4+4+4+4+4+2+1)); 
	  tp->StartMessage(tp->impl, "DC_INFO", DL_DC_INFO, 0+2+4+4+4+2+4+4+4+4+4+4+4+2+1); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _mode); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _utm_east); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _utm_north); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _course); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _buffer); 
...
static inline void DOWNLINK_SEND_MPL3115_BARO(struct DownlinkTransport *tp, uint32_t *_pressure, int16_t *_temp, float *_alt){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+2+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+2+4)); 
	  tp->StartMessage(tp->impl, "MPL3115_BARO", DL_MPL3115_BARO, 0+4+2+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _pressure); 
...
static inline void DOWNLINK_SEND_LINK_STATUS(struct DownlinkTransport *tp, uint8_t *_link_id, float *_time_since_last_msg, uint32_t *_run_time, uint32_t *_rx_bytes, uint32_t *_rx_msgs, uint32_t *_rx_err, float *_rx_bytes_rate, float *_rx_msgs_rate, float *_ping_time){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+4+4+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+4+4+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "LINK_STATUS", DL_LINK_STATUS, 0+1+4+4+4+4+4+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT8, 1, (void *) _link_id); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _time_since_last_msg); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _run_time); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _rx_bytes); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _rx_msgs); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _rx_err); 
...
static inline void DOWNLINK_SEND_ACTUATORS(struct DownlinkTransport *tp, uint8_t nb_values, int16_t *_values){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+nb_values*2))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+nb_values*2)); 
...
static inline void DOWNLINK_SEND_STAB_ATTITUDE_INT(struct DownlinkTransport *tp, int32_t *_est_p, int32_t *_est_q, int32_t *_est_r, int32_t *_est_phi, int32_t *_est_theta, int32_t *_est_psi, int32_t *_sp_phi, int32_t *_sp_theta, int32_t *_sp_psi, int32_t *_sum_err_phi, int32_t *_sum_err_theta, int32_t *_sum_err_psi, int32_t *_stab_cmd_fb_roll, int32_t *_stab_cmd_fb_pitch, int32_t *_stab_cmd_fb_yaw, int32_t *_stab_cmd_ff_roll, int32_t *_stab_cmd_ff_pitch, int32_t *_stab_cmd_ff_yaw, int32_t *_stab_cmd_roll, int32_t *_stab_cmd_pitch, int32_t *_stab_cmd_yaw, int32_t *_stab_cmd_thrust){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "STAB_ATTITUDE_INT", DL_STAB_ATTITUDE_INT, 0+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4); 
	  ...
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_fb_roll); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_fb_pitch); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_fb_yaw); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_ff_roll); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_ff_pitch); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_ff_yaw); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_roll); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_pitch); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_yaw); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _stab_cmd_thrust); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
static inline void DOWNLINK_SEND_GUIDANCE_H_INT(struct DownlinkTransport *tp, int32_t *_sp_x, int32_t *_sp_y, int32_t *_ref_x, int32_t *_ref_y, int32_t *_est_x, int32_t *_est_y){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "GUIDANCE_H_INT", DL_GUIDANCE_H_INT, 0+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_ROTORCRAFT_CAM(struct DownlinkTransport *tp, int16_t *_tilt, int16_t *_pan){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+2))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+2)); 
	  tp->StartMessage(tp->impl, "ROTORCRAFT_CAM", DL_ROTORCRAFT_CAM, 0+2+2); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _tilt); 
...
static inline void DOWNLINK_SEND_FLOW_AP_OTF(struct DownlinkTransport *tp, uint32_t *_counter, int16_t *_velocity, int16_t *_a_attack, int16_t *_a_sidesl, int32_t *_altitude, uint8_t *_checksum){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+2+2+2+4+1))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+2+2+2+4+1)); 
	  tp->StartMessage(tp->impl, "FLOW_AP_OTF", DL_FLOW_AP_OTF, 0+4+2+2+2+4+1); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _counter); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _velocity); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _a_attack); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _a_sidesl); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _altitude); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT8, 1, (void *) _checksum); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
static inline void DOWNLINK_SEND_IMU_MAG_CURRENT_CALIBRATION(struct DownlinkTransport *tp, int32_t *_mx, int32_t *_my, int32_t *_mz, int32_t *_electrical_current){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "IMU_MAG_CURRENT_CALIBRATION", DL_IMU_MAG_CURRENT_CALIBRATION, 0+4+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _mx); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _my); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _mz); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _electrical_current); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}

static inline void DOWNLINK_SEND_UART_ERRORS(struct DownlinkTransport *tp, uint16_t *_overrun_cnt, uint16_t *_noise_err_cnt, uint16_t *_framing_err_cnt, uint8_t *_bus_number){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2+1))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2+1)); 
	  tp->StartMessage(tp->impl, "UART_ERRORS", DL_UART_ERRORS, 0+2+2+2+1); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _overrun_cnt); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _noise_err_cnt); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _framing_err_cnt); 
...
static inline void DOWNLINK_SEND_AHRS_ARDRONE2(struct DownlinkTransport *tp, uint32_t *_state, uint32_t *_control_state, float *_phi, float *_theta, float *_psi, float *_speed_x, float *_speed_y, float *_speed_z, float *_accel_x, float *_accel_y, float *_accel_z, int32_t *_altitude, uint32_t *_battery){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "AHRS_ARDRONE2", DL_AHRS_ARDRONE2, 0+4+4+4+4+4+4+4+4+4+4+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _state); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _control_state); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _phi); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _theta); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _psi); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _speed_x); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _speed_y); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _speed_z); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _accel_x); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _accel_y); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _accel_z); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _altitude); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT32, 4, (void *) _battery); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
static inline void DOWNLINK_SEND_PX4FLOW(struct DownlinkTransport *tp, uint8_t *_sensor_id, int16_t *_flow_x, int16_t *_flow_y, float *_flow_comp_m_x, float *_flow_comp_m_y, uint8_t *_quality, float *_ground_distance){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+2+2+4+4+1+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+2+2+4+4+1+4)); 
	  tp->StartMessage(tp->impl, "PX4FLOW", DL_PX4FLOW, 0+1+2+2+4+4+1+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT8, 1, (void *) _sensor_id); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _flow_x); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _flow_y); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _flow_comp_m_x); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _flow_comp_m_y); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT8, 1, (void *) _quality); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _ground_distance); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
static inline void DOWNLINK_SEND_SONAR(struct DownlinkTransport *tp, uint16_t *_sonar_meas, float *_sonar_distance){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+4)); 
	  tp->StartMessage(tp->impl, "SONAR", DL_SONAR, 0+2+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _sonar_meas); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _sonar_distance); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
void DOWNLINK_SEND_ARDRONE_NAVDATA(struct DownlinkTransport *tp, uint16_t *_taille, uint16_t *_nu_trame, uint16_t *_ax, uint16_t *_ay, uint16_t *_az, int16_t *_vx, int16_t *_vy, int16_t *_vz, uint16_t *_temperature_acc, uint16_t *_temperature_gyro, uint16_t *_ultrasound, uint16_t *_us_debut_echo, uint16_t *_us_fin_echo, uint16_t *_us_association_echo, uint16_t *_us_distance_echo, uint16_t *_us_curve_time, uint16_t *_us_curve_value, uint16_t *_us_curve_ref, uint16_t *_nb_echo, uint32_t *_sum_echo, int16_t *_gradient, uint16_t *_flag_echo_ini, int32_t *_pressure, int16_t *_temperature_pressure, int16_t *_mx, int16_t *_my, int16_t *_mz, uint16_t *_chksum) {}
...
void DOWNLINK_SEND_DOWNLINK_STATUS(struct DownlinkTransport *tp, int8_t *_link_id, uint32_t *_run_time, uint32_t *_rx_bytes, uint32_t *_rx_msgs, uint32_t *_rx_err, float *_rx_bytes_rate, float *_rx_msgs_rate, float *_ping_time) {}
...
void DOWNLINK_SEND_MKK(struct DownlinkTransport *tp, int8_t *_nr, uint8_t *_rpm, int8_t *_current, int8_t *_temp) {}
...
void DOWNLINK_SEND_DC_INFO(struct DownlinkTransport *tp, int16_t *_mode, float *_utm_east, float *_utm_north, float *_course, uint16_t *_buffer, float *_dist, float *_next_dist, float *_start_x, float *_start_y, float *_start_angle, float *_angle, float *_last_block, int16_t *_count, uint8_t *_shutter) {}
...
void DOWNLINK_SEND_MPL3115_BARO(struct DownlinkTransport *tp, uint32_t *_pressure, int16_t *_temp, float *_alt) {}
...
void DOWNLINK_SEND_LINK_STATUS(struct DownlinkTransport *tp, uint8_t *_link_id, float *_time_since_last_msg, uint32_t *_run_time, uint32_t *_rx_bytes, uint32_t *_rx_msgs, uint32_t *_rx_err, float *_rx_bytes_rate, float *_rx_msgs_rate, float *_ping_time) {}
...
void DOWNLINK_SEND_ACTUATORS(struct DownlinkTransport *tp, uint8_t nb_values, int16_t *_values) {}
...
void DOWNLINK_SEND_STAB_ATTITUDE_INT(struct DownlinkTransport *tp, int32_t *_est_p, int32_t *_est_q, int32_t *_est_r, int32_t *_est_phi, int32_t *_est_theta, int32_t *_est_psi, int32_t *_sp_phi, int32_t *_sp_theta, int32_t *_sp_psi, int32_t *_sum_err_phi, int32_t *_sum_err_theta, int32_t *_sum_err_psi, int32_t *_stab_cmd_fb_roll, int32_t *_stab_cmd_fb_pitch, int32_t *_stab_cmd_fb_yaw, int32_t *_stab_cmd_ff_roll, int32_t *_stab_cmd_ff_pitch, int32_t *_stab_cmd_ff_yaw, int32_t *_stab_cmd_roll, int32_t *_stab_cmd_pitch, int32_t *_stab_cmd_yaw, int32_t *_stab_cmd_thrust) {}
...
void DOWNLINK_SEND_GUIDANCE_H_INT(struct DownlinkTransport *tp, int32_t *_sp_x, int32_t *_sp_y, int32_t *_ref_x, int32_t *_ref_y, int32_t *_est_x, int32_t *_est_y) {}
...
void DOWNLINK_SEND_ROTORCRAFT_CAM(struct DownlinkTransport *tp, int16_t *_tilt, int16_t *_pan) {}
...
void DOWNLINK_SEND_FLOW_AP_OTF(struct DownlinkTransport *tp, uint32_t *_counter, int16_t *_velocity, int16_t *_a_attack, int16_t *_a_sidesl, int32_t *_altitude, uint8_t *_checksum) {}
...
void DOWNLINK_SEND_IMU_MAG_CURRENT_CALIBRATION(struct DownlinkTransport *tp, int32_t *_mx, int32_t *_my, int32_t *_mz, int32_t *_electrical_current) {}
void DOWNLINK_SEND_UART_ERRORS(struct DownlinkTransport *tp, uint16_t *_overrun_cnt, uint16_t *_noise_err_cnt, uint16_t *_framing_err_cnt, uint8_t *_bus_number) {}
...
void DOWNLINK_SEND_AHRS_ARDRONE2(struct DownlinkTransport *tp, uint32_t *_state, uint32_t *_control_state, float *_phi, float *_theta, float *_psi, float *_speed_x, float *_speed_y, float *_speed_z, float *_accel_x, float *_accel_y, float *_accel_z, int32_t *_altitude, uint32_t *_battery) {}
...
void DOWNLINK_SEND_PX4FLOW(struct DownlinkTransport *tp, uint8_t *_sensor_id, int16_t *_flow_x, int16_t *_flow_y, float *_flow_comp_m_x, float *_flow_comp_m_y, uint8_t *_quality, float *_ground_distance) {}
...
void DOWNLINK_SEND_SONAR(struct DownlinkTransport *tp, uint16_t *_sonar_meas, float *_sonar_distance) {}
